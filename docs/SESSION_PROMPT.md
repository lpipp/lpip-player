...
- 源码状态：
  main 窗口骨架、配置加载与壁纸安全解析 / preload 空实现 / App.tsx 仅 .stage 画布 / global.css 包含云母、微光与壁纸层材质
- 下一步任务：M0-2 第一个液态玻璃组件 GlassPanel 与基础布局骨架
...
4. git 提交格式：`阶段: 简述`（如 "M0-2: 第一个液态玻璃组件 GlassPanel"），一次提交一个逻辑变更
